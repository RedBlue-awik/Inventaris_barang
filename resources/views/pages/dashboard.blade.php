...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div
            class="bg-white rounded-2xl py-4 px-[1.20rem] border border-slate-100 shadow-sm hover:shadow-md transition-shadow flex justify-between items-start">
            <div>
                <p class="text-xs font-medium text-slate-500 mb-1">Total Aset Barang</p>
                <h3 class="text-3xl p-2 font-bold text-slate-800">{{ number_format($totalBarang ?? 0) }}</h3>
                <p class="text-xs text-slate-400 mt-1">Total jenis barang</p>
            </div>
            <div class="py-2 px-3.5 bg-indigo-50 text-indigo-600 rounded-xl">
        ...
        <div
            ...
            <div>
                ...
                <h3 class="text-3xl p-2 font-bold text-slate-800">{{ number_format($barangMasuk ?? 0) }}</h3>
                <p class="text-xs text-emerald-500 mt-1">Bulan ini</p>
            </div>
            <div class="py-2 px-3.5 bg-emerald-50 text-emerald-600 rounded-xl">
        ...
        <div
            ...
            <div>
                ...
                <h3 class="text-3xl p-2 font-bold text-slate-800">{{ number_format($barangKeluar ?? 0) }}</h3>
                <p class="text-xs text-red-400 mt-1">Bulan ini</p>
            </div>
            <div class="py-2 px-3.5 bg-red-50 text-red-500 rounded-xl">
        ...
        <div
            ...
            <div>
                ...
                <h3 class="text-3xl p-2 font-bold text-slate-800">{{ $stokKritis ?? 0 }}</h3>
                <p class="text-xs text-amber-500 mt-1">Perlu restock segera</p>
            </div>
            <div class="py-2 px-3.5 bg-amber-50 text-amber-500 rounded-xl">
                ...
                @forelse($activities as $act)
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="w-9 h-9 rounded-full bg-{{ $act['color'] }}-100 text-{{ $act['color'] }}-600 flex items-center justify-center text-sm">
