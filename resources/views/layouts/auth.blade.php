...
<head>
    ...
    <link rel="icon" href="{{ asset('Inventaris-App.png') }}" type="image/png">
    <title>@yield('title', 'Autentikasi') - Inventaris-App</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md text-center mb-6">
        <div
            class="w-16 h-16 bg-emerald-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-emerald-600/30 mb-4">
            <i class="fas fa-box-open text-3xl text-white"></i>
        </div>
        <h2 class="text-3xl font-bold text-slate-900">Inventaris-App</h2>
