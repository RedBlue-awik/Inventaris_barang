...
<head>
    ...
    <title>@yield('title', 'Sistem Inventaris') - Inventaris-App</title>
...
<body class="bg-slate-50 text-slate-800">
    ...
    <div class="flex h-screen overflow-hidden relative">
        ...
        <div id="sidebarOverlay"
            class="fixed inset-0 bg-slate-900/50 z-40 hidden md:hidden transition-opacity cursor-pointer"></div>
